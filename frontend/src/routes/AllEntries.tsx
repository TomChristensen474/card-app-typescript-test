...
export default function AllEntries() {
  ...
  return (
    <section className="grid grid-cols-2 md:grid-cols-4 dark:bg-gray-800">
      {entries.map((entry: Entry, index: number) => {
        return (
          <div
            id={entry.id}
            key={index}
            className="bg-gray-300 shadow-md shadow-gray-500 dark:bg-gray-600 dark:text-white dark:shadow-gray-700 m-3 p-4 rounded flex flex-col justify-between "
          >
